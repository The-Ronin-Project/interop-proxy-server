...
class MDMPatientFieldsTest {
    ...
    fun `can get identifiers`() {
        ...
        assertEquals("testID".asFHIR(), mdmPatientFields.identifier[0].value)
    ...
    fun `can get names`() {
        ...
        assertEquals("family".asFHIR(), mdmPatientFields.name[0].family)
        assertEquals(listOf("given", "given2").asFHIR(), mdmPatientFields.name[0].given)
    }
