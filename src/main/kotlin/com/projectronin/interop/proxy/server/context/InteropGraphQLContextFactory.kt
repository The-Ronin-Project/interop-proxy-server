...
/**
 * Factory for creating a GraphQL context map from a request.
 */
@Component
...
fun DataFetchingEnvironment.getAuthorizedTenantId(): String? = this.graphQlContext.get(AUTHZ_TENANT_ID)
